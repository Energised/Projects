...
[**Check if Palindrome**](https://github.com/Gidrek/Projects/tree/master/Text/Palindrome) – Checks if the string entered by the user is a palindrome. That is that it reads the same forwards as backwards like “racecar”
